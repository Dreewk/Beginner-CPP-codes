...
{
public:
     char name[20],mfg[20],exp[20]; //class data members
     int st,netweight;
     float cost;
     char pid[20];
     float discount;
    ...
    void set3()
    {
        int i;
        product *temp;
           // linklist creation for 14 categories. Each categories has 3+ nodes
        head[0]=new product;
...
head[13]=head[13]->prev;
    ...
    void add() //adding a new category
    {
        int cat,stock,nw;
        float cost1;
        product *temp;
        ...
        cout<<"\n"<<"Product id:";  //input the product details
        cin>>pid1;
        cout<<"\n"<<"Product name:";
        cin>>name1;
        cout<<"\n"<<"Mfg date:";
...
void bill()
{
    ...
    cust *temp1;
    char cname[20],nname[20],pd[20],nmfg[20],nexp[20],cl='y';
    bool t=true;
    int qn,c,i=0,tota=0,totp=0,nst,ncst,nnwt;
    cout<<"\n"<<"Enter customer name";
    cin>>cname;
    while(cl=='y')
    {
        ...
        while(strcmp(head[c-1]->pid,pd)!=0)
        {
            ...
            {
                t=false;
                cout<<"\n"<<"Product not found....Entry should be made";
                cout<<"\n"<<"Enter name:";
                cin>>nname;
                cout<<"\n"<<"Stock:";
                cin>>nst;
